  ...
  return imagesType.includes(file.type) ? (
      ...
      >
        ...
        <div className='flex items-center flex-shrink-0 ml-4 space-x-2'>
          <button
            ...
            className='inline-block text-xl font-medium text-gray-500 rounded hover:text-gray-700 focus:ring focus:ring-primary-500 focus:outline-none'
          >
            <HiOutlineEye />
          </button>
          {!readOnly && (
            <button
              ...
              className='text-xl font-medium text-red-500 rounded hover:text-red-700 focus:ring focus:ring-red-500 focus:outline-none'
            >
              <HiX />
            </button>
          )}
    ...
    >
      ...
      <div className='flex items-center flex-shrink-0 ml-4 space-x-2'>
        <UnstyledLink
          href={file.preview}
          className='text-gray-500 rounded hover:text-gray-700 focus:ring focus:ring-primary-500 focus:outline-none'
        >
