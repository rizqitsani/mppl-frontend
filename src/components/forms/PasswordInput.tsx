    ...
    <div>
      ...
      <div className='relative mt-1'>
        <input
          ...
          className={clsx(
            readOnly
              ...
              : 'focus:ring-teal-400 border-gray-300 focus:border-teal-400',
        ...
        <button
          ...
          type='button'
          className='absolute inset-y-0 right-0 flex items-center p-1 mr-3 rounded-lg focus:outline-none focus:ring focus:ring-teal-400'
        >
          {showPassword ? (
